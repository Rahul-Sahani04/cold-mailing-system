...
const DrawerHeader = React.forwardRef(
  ({ children, className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className="flex items-start justify-between gap-x-4 border-b dark:border-gray-200 pb-4 border-gray-900"
        {...props}
      >
        ...
        <DrawerPrimitives.Close asChild>
          <Button
            variant="ghost"
            className="aspect-square p-1 hover:dark:bg-gray-600 hover:bg-gray-400/70 text-black"
          >
